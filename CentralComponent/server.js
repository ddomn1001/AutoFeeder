...
if (wss.clients.size === 0) {
        console.error('No clients are connected. Unable to send data.');
        // Send an error message to the client attempting to send data
        ws.send(JSON.stringify({ error: 'No clients are connected' }));
        return;
    }
